...
# pinecone_store.py
from pinecone import Pinecone, ServerlessSpec
from config import INDEX_NAME, EMBEDDING_DIMENSION, TOP_K

def get_pinecone_client():
    """
    Creates Pinecone client only when needed,
    not at import time — fixes Streamlit Cloud secret loading.
    """
